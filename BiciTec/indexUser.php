...
<br>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="./indexUser.html"> <strong></strong> </a>
          ...
          <ul class="navbar-nav">
          <li class="nav-item">
                <a class="nav-link active" href="./php/tiendaU.php">Tienda</a>
              </li>
              <div class="container-fluid">
    <form class="d-flex" name="busqueda" method="POST" action="php/busquedaU.php">
      ...
      <button class="btn btn-outline-success" type="submit">Buscar</button>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
            <li class="nav-item">
                <a  class="nav-link active " href="./AcercaDeU.html"  aria-disabled="true">Acerca de ...</a>
              </li>
              <li class="nav-fill">
