...
<br>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
              <div class="container-fluid">
    <form class="d-flex" name="busqueda" method="POST" action="php/busquedaI.php">
      ...
      <button class="btn btn-outline-success" type="submit">Buscar</button>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            <li class="nav-item">
                <a  class="nav-link active " href="./AcercaDe.html"  aria-disabled="true">Acerca de ...</a>
              </li>
              ...
              <li class="nav-item">
                <a  class="nav-link active " href="./login.html"  aria-disabled="true">Log In</a>
              </li>
